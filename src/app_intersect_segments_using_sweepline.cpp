...
void display(span<const Vec2> points, span<const Vec2> intersections)
{
...
std::vector<Vec2> execute(std::vector<Vec2> points)
{
  queryCount = 0;
...
BEGIN_ALGO("Intersection/SegmentsUsingSweepline", execute)
