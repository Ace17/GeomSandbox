...
void sandbox_line(Vec2 a, Vec2 b, Color color = White, Vec2 offsetA = {}, Vec2 offsetB = {});
void sandbox_line(Vec3 a, Vec3 b, Color color = White, Vec2 offsetA = {}, Vec2 offsetB = {});
