...
void sandbox_line(Vec2 a, Vec2 b, Color color, Vec2 offsetA, Vec2 offsetB)
{
  gVisualizer->line(a, b, color, offsetA, offsetB);
}
void sandbox_line(Vec3 a, Vec3 b, Color color, Vec2 offsetA, Vec2 offsetB)
{
  gVisualizer->line(a, b, color, offsetA, offsetB);
}
